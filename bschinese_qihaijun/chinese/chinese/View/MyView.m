...
-(void)awakeFromNib{
    colors=[[NSMutableArray alloc]initWithObjects:[UIColor blackColor],[UIColor blueColor],[UIColor redColor],[UIColor blackColor],[UIColor whiteColor], nil];
    WidthArray=[[NSMutableArray alloc]init];
    deleWidthArray=[[NSMutableArray alloc]init];
    pointArray=[[NSMutableArray alloc]init];
    lineArray=[[NSMutableArray alloc]init];
...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([lineArray count]>0) {
        NSLog(@"count===%ld",lineArray.count);
