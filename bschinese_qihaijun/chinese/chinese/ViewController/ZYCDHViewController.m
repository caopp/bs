...
//    _kBkImg.image = imgC;
    ...
    UIImageView *tapZD = [[UIImageView alloc] initWithFrame:CGRectMake((self.view.frame.size.width-40)/3, 20, (self.view.frame.size.width-40)/3, 80)];
    tapZD.image = [UIImage imageNamed:@"indivitor_back"];
    tapZD.userInteractionEnabled = YES;
    tapZD.backgroundColor = [UIColor blackColor];
    
    
    UIImageView *top = [[UIImageView alloc] initWithFrame:CGRectMake(0, 99, self.view.frame.size.width-80, self.view.frame.size.height-20 -30 -20-100-65)];
    ...
    UIImageView *bottom = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height-20 -30 -20-65-10, self.view.frame.size.width-80, 30)];
    ...
    for (int i = 0 ;i <3;i++){
        UIButton *btn =[[UIButton alloc] initWithFrame:CGRectMake(tapZD.frame.size.width /3*i + 10 , 10, (tapZD.frame.size.width - 60)/3, 70)];
    ...
    scrollContent = [[UIScrollView alloc] initWithFrame:CGRectMake(10, 130, self.view.frame.size.width-100, self.view.frame.size.height-20 -30 -20-100-65-30)];
    ...
    scrollContent.contentSize = CGSizeMake((self.view.frame.size.width-100)*3, self.view.frame.size.height-20 -30 -20-100-65-30);
...
-(UIView *)viewCreate:(int)tag{
    UIView *viewContent = [[UIView alloc] initWithFrame:CGRectMake((self.view.frame.size.width-100)*tag, 0, self.view.frame.size.width-100, self.view.frame.size.height-20 -30 -20-100-65-30)];
    viewContent.backgroundColor = [UIColor colorWithRed:0.88 green:0.84 blue:0.78 alpha:1];
    [_wightImg addSubview:viewContent];
    
    
    UIImageView *imageMidden = [[UIImageView alloc] initWithFrame:CGRectMake(viewContent.frame.size.width/3-(tag==2?100:0), 0, viewContent.frame.size.width/6, viewContent.frame.size.height)];
    ...
    UIImageView *resultImg = [[UIImageView alloc] initWithFrame:CGRectMake(viewContent.frame.size.width/2-(tag==2?100:0) +20,tag==0?20:80, viewContent.frame.size.width/2 + (tag==2?100:0)-40, viewContent.frame.size.height-40-(tag==0?0:60))];
    ...
    UIImageView *titleImg = [[UIImageView alloc] initWithFrame:CGRectMake(resultImg.frame.size.width/2-78, -15, 157, 35)];
    ...
    layout.itemSize = CGSizeMake((resultImg.frame.size.width-40-100)/10, (resultImg.frame.size.height - 80 -20-100)/10);
    UICollectionView *collection = [[UICollectionView alloc] initWithFrame:CGRectMake(20, 40, resultImg.frame.size.width-40, resultImg.frame.size.height - 40 -20) collectionViewLayout:layout];
...
-(void)createPYMenuWithSupView:(UIView *)view{
    UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, view.frame.size.width/6, 60)];
    labelTitle.text = @"首字母:";
    labelTitle.textAlignment = NSTextAlignmentCenter;
    [view addSubview:labelTitle];
    
    UIButton *btnSelect = [[UIButton alloc] initWithFrame:CGRectMake(view.frame.size.width/6-50, 10, 192, 45)];
    btnSelect.tag = 88;
    ...
    UICollectionView *collection = [[UICollectionView alloc] initWithFrame:CGRectMake(20, 80, view.frame.size.width/3-40, view.frame.size.height - 80 -20-20) collectionViewLayout:layout];
    collection.layer.masksToBounds = YES;
    collection.tag = 96;
...
-(void)createBSMenuWithSupView:(UIView *)view{
    ...
    UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(20, 80, view.frame.size.width/3-40, view.frame.size.height - 80 -20) style:UITableViewStylePlain];
    ...
    UILabel *labelBH = [[UILabel alloc] initWithFrame:CGRectMake(view.frame.size.width/2 +20, 0, view.frame.size.width/6, 60)];
    labelBH.text = @"剩余笔画:";
    labelBH.textAlignment = NSTextAlignmentCenter;
    [view addSubview:labelBH];
    
    UIButton *btnSelectBH = [[UIButton alloc] initWithFrame:CGRectMake(view.frame.size.width*2/3-40, 10, 192, 45)];
...
-(void)createQBMenuWithSupView:(UIView *)view{
    UIImageView *imageBk = [[UIImageView alloc] initWithFrame:CGRectMake(20, 20, view.frame.size.width/3 - 100-40, view.frame.size.height - 40)];
    ...
    UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(7, 40, view.frame.size.width/3 - 100-53, view.frame.size.height - 40-40) style:UITableViewStylePlain];
    tableview.tag = 99;
        tableview.delegate = self;
        tableview.dataSource = self;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (collectionView.tag == 96) {
        ...
        CGFloat width =(CGRectGetWidth(collectionView.frame)-80)/10
        ;
        CGFloat height =(CGRectGetHeight(collectionView.frame)-80)/10;
