...
- (BPHZCollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == _totalCount/_modeCount ) {
        ...
        // Configure the cell
        NSString *first = [NSString stringWithFormat:@"%ld",indexPath.row *_modeCount+1+_firstCount];
        NSString *second = [NSString stringWithFormat:@"%ld",indexPath.row *_modeCount+_modeCount+_firstCount];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat width =(CGRectGetWidth(collectionView.frame)-40)/4
    ;
    CGFloat height =(CGRectGetHeight(collectionView.frame)-20)/4;
